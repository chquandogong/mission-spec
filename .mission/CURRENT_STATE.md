...
> Last updated: 2026-04-22 | Version: 1.21.2

## 현재 상태

- **Title:** Mission Spec v1.21.2 — Rev.5 3-vendor P1 bundle (§PATCH)
...
- **Rev.5** — 3벤더 재리뷰 (세션 분리 전제, baseline = v1.21.1 HEAD)
